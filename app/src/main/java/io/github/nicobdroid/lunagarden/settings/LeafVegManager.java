...
public class LeafVegManager {
    ...
    private static String[] getMessages(Context context) {
        return context.getResources().getStringArray(R.array.leaf_veg_messages);
    }

    private static String[] getSowMessages(Context context) {
        return context.getResources().getStringArray(R.array.leaf_veg_sow_messages);
    }

    private static String[] getCollectMessages(Context context) {
        return context.getResources().getStringArray(R.array.leaf_veg_collect_messages);
    }
    ...
    private static int getItemCount(String[]... arrays) {
        ...
        if (pictures.length != expected || semis.length != expected || recoltes.length != expected) {
            throw new IllegalStateException("LeafVegManager configuration is inconsistent.");
        }
